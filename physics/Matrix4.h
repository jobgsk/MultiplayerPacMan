...
public:
	...
	Vector3<T> vProduct(Vector3<T> v)
	{
		T x = v.x*MV[0][0] + v.y*MV[1][0] + v.z*MV[2][0] + 1 * MV[3][0];
		T y = v.x*MV[0][1] + v.y*MV[1][1] + v.z*MV[2][1] + 1 * MV[3][1];
		T z = v.x*MV[0][2] + v.y*MV[1][2] + v.z*MV[2][2] + 1 * MV[3][2];
